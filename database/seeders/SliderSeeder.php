...
class SliderSeeder extends Seeder
{
    ...
    public function run()
    {
        $sliders = array(
            ...
            array('name' => 'Before Login Home', 'slider_type' => 'banner', 'slides_per_page' => NULL, 'auto_play' => '0', 'slider_width' => NULL, 'slider_height' => NULL, 'is_active' => '1'),
            array('name' => 'After Login Home', 'slider_type' => 'banner', 'slides_per_page' => NULL, 'auto_play' => '0', 'slider_width' => NULL, 'slider_height' => NULL, 'is_active' => '1'),
        );
