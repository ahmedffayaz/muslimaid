...
if(array_key_exists('min_cashout_amount',SiteSetting()->toArray()))
 $min = SiteSetting()['min_cashout_amount']; else $min = 1;
   @endphp
@php
$user = Auth::user(); 
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__actions align-self-center">
                                                <div class="product-card__buttons mt-2">
                                                    ...
                                                    <form action="{{route('account.cashout')}}" class="m-auto form_withdraw" form_id="value" method="POST">
                                                        @csrf
                                   ...
                                   @if(SiteSetting()['payment_method_bank'])
                                            ...
                                            <div class="product-card__actions align-self-center">
                                                <div class="product-card__buttons mt-2">
                                                    ...
                                                    <form action="{{route('account.cashout')}}" class="m-auto form_withdraw" form_id="value" method="POST">
                                                        ...
                                                        <button type="submit"
                                                            @if (Auth::user()->availableBalance() < $min)
                                                            class="btn btn-success withdraw_submit" disabled 
                                                            @elseif(in_array( 'pending',$cashout_status)||in_array( 'processing donation',$cashout_status))
                                                            class="btn btn-success popoverData disabled" rel="popover" data-placement="bottom" data-content="You already have a withdraw request" data-trigger="hover" 
                                                            @else
                                                            class="btn btn-success submit" 
                                    ...
                                    <div class="products-list__item">
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            {{-- {{dd(in_array( 'processing donation',$cashout_status))}} --}}
                                            <div class="product-card__actions align-self-center">
                                                <div class="product-card__buttons mt-2">
                                                    @if(Auth::user()->availableBalance() < $min)
                                                    <p class="small">Your cashback balance is currently less than £{{$min}}</p>
                                                    ...
                                                    <button   
                                                        @if (Auth::user()->availableBalance() < $min)
                                                        class="btn btn-success m-auto" disabled
                                                        ...
                                                        @else
                                                        class="btn btn-success m-auto"  id="charity-modal-show"
                                                        @endif>Withdraw
                                                    </button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg ">
                                            <div class="modal-content" id="quickview-modal-content"> 
                                                <div class="quickview pt-5" style="padding: 20px">
                                                        ...
                                                        <div class="container">
                                                            <form action="{{route('account.CharityCashout')}}" id="form_withdraw" method="POST">
                                                                @csrf
                                                               <div class="row g-4 pt-4">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                     <p>With Cashblack Giveback, when you choose to donate your cashback to one of yor affiliate charities , goodwill causes or community interests companies , we'll match your donation 100%</p>  
                                                                    ...
                                                                    <div class="col-12 py-3">
                                                                        <div class="form-inline">
                                                                            <div class="form-group">
                                                                                <label class="form-label pr-3 mr-3" for="charity"><strong> Select Charity</strong> </label>
                                                                    ...
                                                                    <div class="cart">
                                                                            <table class="cart__table cart-table" style="font-size: 12px">
                                                                                <thead class="cart-table__head">
                                                                                    <tr class="cart-table__row">
                                                                                        <input type="hidden" name="payment_method"  value="charity">
                                                                                       <th class="cart-table__column cart-table__column--price text-center">Store</th>
                                                                                       <th class="cart-table__column cart-table__column--price text-center">Order Amount</th>
                                                                                       <th class="cart-table__column cart-table__column--price text-center">Cashback</th>
                                                                                       <th class="cart-table__column cart-table__column--price text-center">Date</th>
                                                                                       <th class="cart-table__column cart-table__column--price text-center">Giveback Amount</th>
                                                                                  ...
                                                                                  <input type="hidden" name="id" id="id" value="{{$cashback->id}}">
                                                                                    <tr class="cart-table__row">
                                                                                        <td class="cart-table__column cart-table__column--product">
                                                                                            <p class="cart-table__product-name text-center">{{$cashback->store->name}}</p>
                                                                                        </td>
                                                                                        <td class="cart-table__column cart-table__column--product">
                                                                                            <p class="cart-table__product-name text-center" > {{ currency() }}{{number_format((float)$cashback->order_value, 2, '.', '')}}</p>
                                                                                        </td>
                                                                                        <td class="cart-table__column cart-table__column--product">
                                                                                            <p class="cart-table__product-name text-center value_amount" > {{ currency() }} {{number_format((float)$cashback->amount, 2, '.', '')}}</p>
                                                                                        </td>
                                                                                        <td class="cart-table__column cart-table__column--product pt-0">
                                                                                            {{Carbon\Carbon::parse($cashback->event_date)->isoFormat('Do MMMM YYYY')}}</td>
                                                                                        <td class="cart-table__column cart-table__column--product text-center">
                                                                                            <input type="checkbox" id="add_amount" class="add_amount checkbox" name="amount" value="{{$cashback->amount}}">
                                                                                            {{-- <label><input type="checkbox" name="amount[]"  class="add_amount checkbox" id="add_amount" value="{{$cashback->amount}}"></label> --}}
                                                                                        </td>
                                                                                ...
                                                                                <div class="col-12 col-md-7 col-lg-6 col-xl-5">
                                                                                            <table class="cart__totals" style="width: 80%"> 
                                                                                                <thead class="cart__totals-header">
                                                                                                    <tr>
                                                                                                        <th><strong>Total Donation:</strong> </th>
                                                                                                        <td>{{currency()}}</td>
                                                                            ...
                                                                            {{-- <div class="col-12"> --}}
                                                                                <div class="form-group float-right">
                                                                                    <button class="btn btn-primary submit" form-id="{{$cashback->id}}" type="submit">Cashout Now</button> 
                                                                                </div>
                                                                            {{-- </div> --}}
                                                                        </div>
