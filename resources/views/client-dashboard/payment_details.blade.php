            ...
            <div class="col-12 col-lg-9 mt-4 mt-lg-0">
              <div class="row ">
                <div class="col-lg-12">
                    ...
                    <p>Your earned cashback can be withdrawn in a variety of means. All details will be stored safely and securely and can be changed at any time. To request a payment please visit the <a href="{{route('account.withdraw.index')}}">Withdraw</a> page.</p>
                              ...
                              <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="account_name" name="account_name" required value="{{$user->bankInfo->account_name ?? ''}}"> 
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="bank_title" name="bank_title" required value="{{$user->bankInfo->bank_title ?? ''}}">
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="account_number" name="account_number" required value="{{$user->bankInfo->account_number ?? ''}}">
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="bank_sort_code" name="bank_sort_code" required value="{{$user->bankInfo->bank_sort_code ?? ''}}">
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <div class="form-control-wrap">
                                          <input type="text" class="form-control" id="paypal_email" name="paypal_email" required value="{{$user->paypalInfo->paypal_email ?? ''}}">
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-12">
