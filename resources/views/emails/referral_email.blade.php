                ...
                <tbody>
                    <tr>
                        <td class="p-3 p-sm-5">
                            ...
                            <p>Join me at Cashblack where you can earn money when you shop online</p>
                            <p>Click my referral link below to sign up so you can browse, shop and earn while supporting Black-owned businesses with Cashblack!</p>
                            <a href="{!! $link !!}"><input type="button" class="btn btn-success"></a>
                        </td>
                    </tr>
                </tbody>
            </table>
