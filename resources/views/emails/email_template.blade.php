...
ul.email-social li .icon {font-size: 20px;}
    ul.email-social li a {padding:7px}
</style>
<body>
                    ...
                    <tr>
                        <td class="text-center pt-4">
                            ...
                            <ul class="email-social">
                                ...
                                <li><a href="{{SiteSetting()['facebook']}}"><img src="{{ asset('admin-dashboard/images/socials/facebook.png')}}" alt=""></a></li>
                                @endisset
                                @isset(SiteSetting()['twitter'])
                                <li><a href="{{SiteSetting()['twitter']}}"><img src="{{ asset('admin-dashboard/images/socials/twitter.png')}}" alt=""></a></li>
                                @endisset
                                @isset(SiteSetting()['instagram'])
                                <li><a href="{{SiteSetting()['instagram']}}"><img src="{{ asset('admin-dashboard/images/socials/instagram.png')}}" alt=""></a></li>
                                @endisset
                                @isset(SiteSetting()['linkedin'])
                                <li><a href="{{SiteSetting()['linkedin']}}"><img src="{{ asset('admin-dashboard/images/socials/linkedin.png')}}" alt=""></a></li>
                                @endisset
                                @isset(SiteSetting()['pinterest'])
                                <li><a href="{{SiteSetting()['pinterest']}}"><img src="{{ asset('admin-dashboard/images/socials/pinterest.png')}}" alt=""></a></li>
                                @endisset
                            </ul>
