                                            ...
                                            <div id="side-sortables" class="accordion-container">
                                                <ul class="outer-border">
                                                    <li class="control-section accordion-section  open add-page" id="add-page">
                                                        <h3 class="accordion-section-title hndle" tabindex="0">Menu Item<span class="screen-reader-text">Press return or
                                                            ...
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    ...
                                                                    <p id="menu-item-name-wrap">
                                                                        <label class="howto" for="custom-menu-item-name"> <span>Label</span>&nbsp;
                                                                            <input id="custom-menu-item-name" name="label" type="text"
                                                                                class="regular-text menu-item-textbox input-with-default-title" title="Label menu">
                                                                        </label>
                                                                    </p>
                                                                    ...
                                                                    <p class="button-controls">
                                                                        ...
                                                                        <a href="#" onclick="addcustommenu()" class="button-secondary submit-add-to-menu right">Add menu
                                                                            item</a>
                                                ...
                                                <div id="nav-menu-header">
                                                    <div class="major-publishing-actions">
                                                        <label class="menu-name-label howto open-label" for="menu-name"> <span>Name</span>
                                                            <input readonly="readonly" name="menu-name" id="menu-name" type="text"
                                                                class="menu-name regular-text menu-item-textbox" title="Enter menu name"
                                                                value="@if (isset($indmenu)) {{ $indmenu->name }} @endif" style="width: 200px!important;">
                                                            <input name="menu-title" id="menu-title" type="text" class="menu-title regular-text menu-item-textbox"
                                                                title="Enter menu title" placeholder="Enter menu title"
                                                                value="@if (isset($indmenu)) {{ $indmenu->title }} @endif" style="width: 200px;">
                                                        ...
                                                        @elseif(request()->has('menu'))
                                                            <div class="publishing-action">
                                                                <a onclick="getmenus()" name="save_menu" id="save_menu_header" class="button button-primary menu-save">Save
                                                                    menu</a>
                                                                    ...
                                                                    <li id="menu-item-{{ $m->id }}"
                                                                        ...
                                                                        <div class="menu-item-settings" id="menu-item-settings-{{ $m->id }}">
                                                                                ...
                                                                                <p class="field-css-role description description-wide">
                                                                                    <label for="edit-menu-item-role-{{ $m->id }}"> Role
                                                                                        ...
                                                                                        <select id="role_menu_{{ $m->id }}" class="widefat code edit-menu-item-role"
                                                                                            ...
                                                                                            <option value="0">Select Role</option>
                                                                                            @foreach ($roles as $role)
                                                                                                <option @if ($role->id == $m->role_id) selected @endif
                                                                            ...
                                                                            <div class="menu-item-actions description-wide submitbox">
                                                                                ...
                                                                                <span class="meta-sep hide-if-no-js"> | </span>
                                                                                <a onclick="getmenus()" class="button button-primary updatemenu"
