                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                @if (isFacebookEnabled() || isGoogleEnabled())
                                    <div>
                                        ...
                                        @if (isFacebookEnabled())
                                            <a class="btn btn-primary border-0 fb-button" style="background-color: #3b5998; border-radius: 2px"
                                                href="{{ url('/login/facebook') }}" role="button">
                                                <i class="fab fa-facebook-f"></i> Join with Facebook</a>
                                        @endif
                                        @if (isGoogleEnabled())
                                            <a class="btn btn-primary border-0 ml-2 g-button" style="background-color: #dd4b39; border-radius: 2px"
                            ...
                            <div class="col-md-5 d-flex flex-column">
                                ...
                                <p>
                                    <span class="mr-3" style="font-family: wingdings; font-size: 120%; color:green;">&#10004;</span>
                                    A few clicks to get cashback
                                </p>
                                <p>
                                ...
                                <p>
                                    <span class="mr-3" style="font-family: wingdings; font-size: 120%; color:green;">&#10004;</span>
                                    Get cashback and/or discount codes
                                </p>
                                <p>
                                    <span class="mr-3" style="font-family: wingdings; font-size: 120%; color:green;">&#10004;</span>
                                    Join the thousands of people who are saving money when they buy from 500+ popular brands
                                </p>
                            </div>
                        </div>
                    </div>
