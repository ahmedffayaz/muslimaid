                         ...
                         <div class="col-md-12 pl-0">
                            <h1 class="col-md-5 float-left">Cashback To Your Door</h1>
                                    <div class="col-md-5 float-right  d-flex flex-justify-between">
                                            <select class="form-control width store form-control-select2" multiple data-placeholder="Select Stores" id="select-categories" onchange="showStores()">
  ...
  function orderByDistanceRendering(arrs) {
       ...
       $.each(arrs, function(index, location){
           var tags = '<ul class="tags">';
               if (location[14] != "" && location[14] != null){
                   ...
                   $.each(menus, function(index, menu){
                       tags += '<li><a href="'+location[13]+'/'+menu+'">'+location[15][menu]+'</a></li>';
                   })
               }
               tags += '</ul>';
           storesHtml += '<li class="list-item col">\n' +
               ...
               '                                    <img src="'+location[12]+'" alt="" class="img-fluid">\n' +
               ...
               '                                    '+tags+'\n' +
               '                                <p class="address">'+location[6].replace("-","'")+'</p>\n' +
               '                                <div class="distance calculatedDistance" id="distance">'+location[16]+' miles away</div>\n' +
               '                            </div>\n' +
               '                        </li>';
       });
