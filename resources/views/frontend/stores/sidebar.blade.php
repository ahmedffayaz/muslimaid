                ...
                <ul class="widget-categories__list" data-collapse data-collapse-opened-class="widget-categories__item--open">
                   <li class="widget-categories__item mb-4" data-toggle="popover" title="98% tracked" data-content="On average, 98% transactions at this retailer track in to your Activity within less than 24 hours">
                    ...
                    <li class="widget-categories__item mb-4" data-toggle="popover" title="Less than 24 hours" data-content="On average, purchases at this retailer track into your Activity in less than 24 hours.">
                        <div class="widget-categories__row">
                            <div class="col-3 pl-0">
                                <svg class="fill-primary" id="icon-stats-claims" viewBox="0 0 24 24"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm0 22.5C6.2 22.5 1.5 17.8 1.5 12S6.2 1.5 12 1.5 22.5 6.2 22.5 12 17.8 22.5 12 22.5z"></path><path d="M12 8h4v2h-4zm-3 3h7v2H9zm-3 3h10v2H6z"></path></svg>
                            </div>
                    ...
                    <li class="widget-categories__item" data-toggle="popover" title="Less than 9 months" data-content="On average, cashback for this retailer will take less than 9 months to be confirmed">
                        <div class="widget-categories__row">
                            <div class="col-3 pl-0">
                                <svg class="fill-primary" id="icon-stats-payment" viewBox="0 0 24 24"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm0 22.5C6.2 22.5 1.5 17.8 1.5 12S6.2 1.5 12 1.5 22.5 6.2 22.5 12 17.8 22.5 12 22.5z"></path><path d="M8.5 14.7l1-.3v-1.8h-1V11h1v-1c0-.9.3-1.7.8-2.2.5-.5 1.3-.8 2.3-.8 1.5 0 2.3.6 2.9 1.5L14 9.6c-.4-.6-.8-.8-1.4-.8-.3 0-.5.1-.7.3-.2.2-.3.5-.3.9v1h3v1.6h-3v1.7h4V16h-7v-1.3z"></path></svg>
                            </div>
