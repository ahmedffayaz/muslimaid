                            ...
                            <div class="col-md-4">
                                <div class="block-product-columns__column pt-2">
                                    <div class="block-product-columns__item">
                                        <div class="product-card product-card--hidden-actions product-card--layout--horizontal product-card__quickvieww" type="button"
                                            toggle="model" data-target="#quickview-modal" data-id="{{ $charity->id }}" style="min-height: 150px">
