...
@section('content')
    ...
    <div class="container p-3 my-2 mt-2">
        @php $mainCategory = $category; @endphp
                                    ...
                                    <div class="bhoechie-tab-content @if ($key == 0) active @endif">
                                        <div class="row">
                                            <div class="col-lg-12 align-self-center py-4">
                                                <img style="max-height: 50px;" class="mb-2" alt=""
                                                    @if ($pick->store->logo->first()) 
                                                ...
                                                <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas fermentum, diam non iaculis 
                                                    finibus, ipsum arcu sollicitudin dolor.
                                                </p>
                                                <p>
                                                    <b>
                                                        @if ($pick->store->cashback->type == 'fixed') {{ $pick->store->cashback->currency }} @endif
                                                        {{ $pick->store->cashback->sale_commission }}
                                                        @if ($pick->store->cashback->type == 'percentage') % @endif 
                                                        Cashback
                                                    </b>
                                                </p>
                                ...
                                <div class="list-group">
                                    @foreach ($category->picks->take(5) as $key => $pick)
                                        <a href="#" class="list-group-item @if ($key == 0) active @endif text-center">
                                            <img style="max-height: 40px;" class="" alt=""
                                                @if ($pick->store->logo->first()) 
