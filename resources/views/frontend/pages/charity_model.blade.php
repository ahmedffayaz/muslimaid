                ...
                <div class="product-gallery">
                    <div class="">
                        <div class="owl-carousel" id="product-image" style="display: block !important">
                            ...
                            <div class="product-image product-image--location--gallery">
                                <a href="{{ asset('storage/charities/images/' . $charity->banner_upload) }}" data-width="700" data-height="700" class="product-image__body"
                                    target="_blank">
            ...
            <div class="product__info">
                ...
                <ul class="product__meta">
                    <li class="product__meta-availability">
                        Charity Type: <span class="text-success">{{ $charity->charity_type->title }}</span>
                    </li>
