...
<head>
    ...
    <link rel="icon" type="image/png"
        href="@isset($settings['favicon']) {{ asset('storage/dashboard/images/logo/' . $settings['favicon']) }} @else {{ asset('frontend/images/favicon.png') }} @endisset">
    <!-- fonts -->
...
<body>
    ...
    <div style="margin-top:200px;text-align:center">
        ...
        <img class="mr-5" alt="logo"
            src="@if (isset($settings['website_logo']) && $settings['website_logo'] != 'default.png') {{ asset('storage/dashboard/images/logo/' . $settings['website_logo']) }} @else {{ asset('admin-dashboard/images/logo.png') }} @endisset">
