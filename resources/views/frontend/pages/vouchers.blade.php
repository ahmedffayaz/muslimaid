                    ...
                    <div class="products-view">
                                            ...
                                            <div class="product-card product-card--hidden-actions ">
                                                <div class="product-card__image product-image">
                                                    <a href="{{ route('store.show', $store->slug) }}" class="product-image__body">
                                                        <img class="product-image__img" alt="logo"
                                                            @if ($store->logo->first()) 
                                                ...
                                                <div class="product-card__actions align-self-center">
                                                    <div class="product-card__buttons mt-2">
                                                        <a href="{{ route('store.show', $store->slug) }}"
                                                            class="btn btn-primary product-card__addtocart product-card__addtocart--list" type="button">Shop Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @else
                            <div class="text-center">
                                <img src="{{ asset('frontend/images/item_no.png') }}" alt="no_voucher">
