            ...
            <div class="block post post--layout--classic">
                <div class="post__header post-header post-header--layout--classic">
                    ...
                    <div class="post-header__meta">
                        ...
                        <div class="post-header__meta-item"><a href="">{{Carbon\Carbon::parse($blog->created_at)->isoFormat('Do MMMM YYYY')}}</a></div>
                ...
                <div class="post__featured">
                    <a href="">
                        ...
                        @else
                        src="{{asset('frontend/images/posts/post-featured.jpg')}}" @endif 
                         alt="">
                    </a>
                </div>
                ...
                <div class="post__footer">
                    ...
                    {{-- <div class="post-author">
                        <div class="post-author__avatar">
                            <a href=""><img src="{{asset('frontend/images/avatars/avatar-1.jpg')}}" alt=""></a>
                        </div>
                        ...
                        <div class="related-posts__list">
                            <div class="related-posts__item post-card post-card--layout--related">
                                <div class="post-card__image">
                                    <a href="">
                                        <img src="{{asset('frontend/images/posts/post-1.jpg')}}" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="related-posts__item post-card post-card--layout--related">
                                <div class="post-card__image">
                                    <a href="">
                                        <img src="{{asset('frontend/images/posts/post-2.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="post-card__info">
                                    <div class="post-card__name">
                ...
                {{-- <section class="post__section">
                    ...
                    <ol class="comments-list comments-list--level--0">
                            ...
                            <div class="comment-list__children">
                                <ol class="comments-list comments-list--level--1">
                                    <li class="comments-list__item">
                                        <div class="comment">
                                            <div class="comment__avatar">
                                                <a href=""><img src="{{asset('frontend/images/avatars/avatar-2.jpg')}}" alt=""></a>
                                            </div>
                                            <div class="comment__content">
                                                <div class="comment__header">
                                                    <div class="comment__author">
                                    ...
                                    <li class="comments-list__item">
                                        <div class="comment">
                                            <div class="comment__avatar">
                                                <a href=""><img src="{{asset('frontend/images/avatars/avatar-3.jpg')}}" alt=""></a>
                                            </div>
                                            <div class="comment__content">
                                                <div class="comment__header">
                                                    <div class="comment__author">
                        ...
                        <li class="comments-list__item">
                            <div class="comment">
                                <div class="comment__avatar">
                                    <a href=""><img src="{{asset('frontend/images/avatars/avatar-4.jpg')}}" alt=""></a>
                                </div>
                                <div class="comment__content">
                                    <div class="comment__header">
                                        <div class="comment__author">
