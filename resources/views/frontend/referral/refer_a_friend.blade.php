                            ...
                            <div class="posts-list__body">
                                        ...
                                        <div class="row g-3 align-center">
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="cashback_percentage">Invite Your Friends<em class="icon ni ni-question form-label"
                                            ...
                                            <div class="col-lg-9">
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="text" class="form-control" name="referral_email"  id="referral_email" value="" placeholder="Enter email">
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="ref_link"  value="{{ url('/register-form?referby=' . base64_encode($user = \Auth::user()->id)) }}" readonly>
