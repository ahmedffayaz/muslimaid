        ...
        <div class="site-header__middle container">
            <div class="site-header__logo">
                <a href="{{ url('/') }}">
                    <img width="100%"
                        src="
                            @if (isset($settings['website_logo']) && $settings['website_logo'] != 'default.png') 
                ...
                <div class="nav-panel__indicators ml-3">
                    @if (Auth::check())
                        <div class="indicator indicator--trigger--hover">
                            ...
                            <a href="@if (Auth::user()->hasRole('user')) {{ route('account.dashboard') }} @elseif (Auth::user()->hasRole('admin')) {{ route('admin.home.index') }} @endif"
                            ...
                            <div class="indicator__dropdown mt-3">
                                <div class="account-menu mt-1">
                                    ...
                                    <a onclick="" class="account-menu__user">
                                        ...
                                        <div class="account-menu__user-info">
                                            ...
                                            <div class="account-menu__user-email">
                                                Balance: {{ currency() }} </span>{{ number_format((float) Auth::user()->availableBalance(), 2, '.', '') }}
                                            </div>
                                        </div>
                                    </a>
                                    <div class="account-menu__divider"></div>
                    ...
                    @else
                        <a class="nav-links__item-link" href="{{ route('login') }}">
                            <div class="nav-links__item-body">
                                Login
                            </div>
                        </a>
                        <a class="nav-links__item-link" href="{{ route('register') }}">
                            <div class="nav-links__item-body">
                                Register
                            </div>
                        </a>
