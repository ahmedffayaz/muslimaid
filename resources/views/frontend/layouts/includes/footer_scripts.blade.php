    ...
    $(".search__input").keydown(function(e) {
        switch (e.which) {
            case 40:
                ...
                $('li:not(:last-child).suggestions__item.selected').removeClass('selected').next().addClass('selected');
            ...
            case 38:
                e.preventDefault(); // prevent moving the cursor
                $('li:not(:first-child).suggestions__item.selected').removeClass('selected').prev().addClass('selected');
