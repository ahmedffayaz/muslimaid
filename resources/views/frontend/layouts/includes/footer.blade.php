    ...
    <div class="site-footer mt-0">
        <div class="container">
                    ...
                    <div class="col-6 col-md-6 col-lg-2">
                        <div class="site-footer__widget footer-links">
                            ...
                            <ul class="footer-links__list">
                                @if (isset($footer_menu_column_1))
                                    @foreach ($footer_menu_column_1->items as $item)
                                        <li class="footer-links__item">
                                            <a href="{{ $item->link }}" class="footer-links__link">
                                                {{ $item->label }}
                                            </a>
                                        </li>
                                    @endforeach
                        ...
                        <div class="site-footer__widget footer-newsletter">
                            ...
                            <form action="{{ route('newsletter.store') }}" class="footer-newsletter__form" method="POST">
                                ...
                                <div class="col-md-8 p-0">
                                    <input type="text" name="email" class="footer-newsletter__form-input form-control" id="footer-newsletter-address"
            ...
            <div class="site-footer__bottom">
                <div class="site-footer__copyright">{{ $settings['footer_text'] ?? '' }}</div>
