    ...
    <div class="site-header">
        <div class="site-header__middle container">
                ...
                <div class="search search--location--header ">
                    <div class="search__body">
                        <form class="search__form" action="{{route('search')}}">
                            ...
                            <input class="search__input" name="search" placeholder="Search over 10,000 stores" value="" aria-label="Site search" type="text" autocomplete="off">
            ...
            <div class="site-header__phone">
                ...
                <div class="site-header__phone-number"><span class="currency">{{ Config::get('currency') }} </span>{{Auth::user()->balance->sum('amount')}}</div>
                @endauth
                    ...
                    <div class="nav-panel__row">
                        ...
                        <div class="nav-panel__nav-links nav-links">
                            <ul class="nav-links__list">
                                ...
                                <li class="nav-links__item  nav-links__item--has-submenu ">
                                    <a class="nav-links__item-link" href="{{route('offers')}}">
                                        <div class="nav-links__item-body"> Offers</div>
                                    </a>
                                </li>
                                <li class="nav-links__item  nav-links__item--has-submenu ">
                                    <a class="nav-links__item-link" href="{{route('vouchers')}}">
                                        <div class="nav-links__item-body"> Vouchers</div>
                                    </a>
                                </li>
                                <li class="nav-links__item  nav-links__item--has-submenu ">
                                    <a class="nav-links__item-link" href="{{route('about')}}">
                                        <div class="nav-links__item-body"> About</div>
                                    </a>
                                </li>
                                <li class="nav-links__item  nav-links__item--has-submenu ">
                                    <a class="nav-links__item-link" href="{{route('blog')}}">
                            ...
                            <div class="indicator indicator--trigger--hover">
                                ...
                                <div class="indicator__dropdown">
                                    <div class="account-menu">
                                        ...
                                        <a href="@if(Auth::user()->hasRole('user')){{route('account.dashboard')}}@elseif(Auth::user()->hasRole('admin')){{route('admin.home.index')}}@endif" class="account-menu__user">
                                        ...
                                        <ul class="account-menu__links">
                                            <li><a href="@if(Auth::user()->hasRole('user')){{route('account.dashboard')}}@elseif(Auth::user()->hasRole('admin')){{route('admin.home.index')}}@endif">Dashboard</a></li>
