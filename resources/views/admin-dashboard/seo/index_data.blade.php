...
<div class="nk-tb-item">
    ...
    <div class="nk-tb-col">
        <div class="tb-lead"><span><a href="{{route('admin.seo.edit', $seo)}}" class="a_link">{{$seo->url}}</a></span></div>
    </div>
    <div class="nk-tb-col">
        <span>{{$seo->title}}</span>
    </div>
                ...
                <div class="drodown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <ul class="link-list-opt no-bdr">
                            <li><a href="{{route('admin.seo.edit', $seo)}}"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                           <li><a  form_id="delete-blog-{{$seo->id}}"  class="delete" style="cursor: pointer"> <em class="icon ni ni-trash-fill"></em><span>Delete</span></a>
