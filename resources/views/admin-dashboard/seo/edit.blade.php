                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input id="blog-title" type="text" class="form-control " name="url" placeholder="Url" value="{{ $seo->url }}"
                                                            readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-11">
                                                <div class="rule-type-container remove" data-count="{{ $seo->ruleData->count() }}">
                                                    @foreach ($seo->ruleData as $key => $rule_data)
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap ">
                                                                <div class="form-control-select">
                                                                    <select class="form-control rule_type" data-type_count="{{ $key }}" id="rule_type"
                                                                        name="type[{{ $key }}][rule_type]" required>
                                                        ...
                                                        <div class="remove">
                                                            @if ($rule_data->type == 'meta_title')
                                                                <div class="form-group">
                                                                    <label class="form-label" for="reviewer">Meta Title</label>
                                                                    <div class="form-control-wrap">
                                                                        <input id="seo-title" type="text" class="form-control " name="type[{{ $key }}][value]"
                                                                            placeholder="Meta Title" value="{{ $rule_data->value }}" required>
                                                                    </div>
                                                                </div>
                                                            @elseif ($rule_data->type == 'meta_keyword')
                                                                <div class="form-group">
                                                                    <label class="form-label" for="reviewer">Meta Keywords</label>
                                                                    <div class="form-control-wrap">
                                                                        <input id="seo-keyword" type="text" class="form-control " name="type[{{ $key }}][value]"
                                                                            placeholder="Meta keyword" value="{{ $rule_data->value }}" required>
                                                                    </div>
                                                                </div>
                                                            @else
                                                                <div class="form-group">
