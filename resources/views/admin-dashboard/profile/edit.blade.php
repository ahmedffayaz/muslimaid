                                        ...
                                        <div class="nk-block">
                                            ...
                                            <form action="{{route('admin.profile.update', $profile)}}" class="gy-3 form-settings form-validate is-alter" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row g-3 align-center">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            <img id="image_avatar" src="@if($profile->avatar != 'default.png' && Storage::exists('public/users/images/avatar/' . $profile->avatar)){{asset('storage/users/images/avatar/'.$profile->avatar)}}@else{{asset('admin-dashboard/images/avatar.png')}}@endif" alt="store logo" class=""  width="100" style="border-radius: 50%; height: 100px"/>
