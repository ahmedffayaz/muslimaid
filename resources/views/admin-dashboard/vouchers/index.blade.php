                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt"><a href="{{route('admin.vouchers.create')}}" class="btn btn-primary btn-sm" ><em class="icon ni ni-plus"></em><span>Add Voucher</span></a></li>
            ...
            <div class="modal-body modal-body-lg text-center">
                <div class="nk-modal">
                    ...
                    <div class="nk-modal-action">
                        <a href="{{route('admin.importer.vouchers')}}" class="btn btn-lg btn-mw btn-primary">Run</a>
                    </div>
                </div>
            </div><!-- .modal-body -->
