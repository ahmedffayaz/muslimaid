                    ...
                    <div class="form-control-wrap">
                        <input type="url" class="form-control" id="tracking_url" value="{{ $voucher->tracking_url }}"
                            ...
                            <span style="position: absolute; right:0; top:5px; width:20%" data-toggle="tooltip" data-placement="left"
                                title="This parameter containing ID of the click will be concatenated with tracking URL of the store ({{ $voucher->store->tracking_url ? $voucher->store->tracking_url : '' }})">{{ $voucher->store->network->click_ref }}XXX</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <span style="position:absolute; left:0; top:5px; width:7%" data-toggle="tooltip" data-placement="right"
                            title="This parameter containing URL of the click will be concatenated with deeplink URL of the store ({{ $voucher->store->deeplink_url ? $voucher->store->deeplink_url : '' }})">{{ $voucher->store->network->deeplink_identifier }}</span>
