                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="form-select form-control" data-search="on" value="{{ $voucher->store_id }}" id="store_id" name="store_id"
                                                            required>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="destination" value="{{ $voucher->destination }}" name="destination"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    ...
                                                    <div id="editor-container">{!! $voucher->description !!}</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="promotion_type" value="{{ $voucher->promotion_type }}" name="promotion_type"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="coupon_code" value="{{ $voucher->coupon_code }}" name="coupon_code"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="sale_commission" value="{{ $voucher->sale_commission }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control date-picker" id="promotion_start_date"
                                                            value="{{ $voucher->promotion_start_date }}" name="promotion_start_date" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control date-picker" id="promotion_end_date"
                                                            value="{{ $voucher->promotion_end_date }}" name="promotion_end_date" required>
                                                    </div>
                                                </div>
                                            </div>
