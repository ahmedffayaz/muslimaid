                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control date-picker" id="promotion_start_date" value="{{\Carbon\Carbon::parse($voucher->promotion_start_date)->format('m/d/Y')}}" name="promotion_start_date" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control date-picker" id="promotion_end_date" value="{{\Carbon\Carbon::parse($voucher->promotion_end_date)->format('m/d/Y')}}" name="promotion_end_date" required>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- <div class="col-lg-6">
