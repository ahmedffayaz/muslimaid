                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-body collapse" id="accordion-item-1-1" data-parent="#accordion-1">
                                    <div class="accordion-inner">
                                        <div><form action="{{route('admin.tickets.search')}}" class="form-validate is-alter search_form" method="POST">
                                            @csrf
                                            <div class="row g-4">
                                                <div class="col-lg-2">
        ...
        $(document).ready(function(){
         ...
         $(document).on('submit', '.search_form', function(event){
            ...
            $.ajax({
              ...
              method:"POST",
              data:{_token:_token,user_id:user_id,ticket_id:ticket_id,category:category,status:status,priority:priority},
              success:function(data)
              {
               $('#table-data').html(data);
               $('html, body').animate({ scrollTop: 0 }, 'slow');
