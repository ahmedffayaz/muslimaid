                                        ...
                                        <div class="nk-msg-head-meta align-items-start">
                                            ...
                                            <ul class="nk-msg-actions">
                                                <li class="text-right">@if($ticket->status!='closed')
                                                    ...
                                                    <form action="{{ route('admin.tickets.close', $ticket) }}" id="close-{{$ticket->id}}" method="POST" class="m-0">
                                                        @method('PUT')
                                                        @csrf
                                                    ...
                                                    @else 
                                                    <button href="#" class="btn btn-sm btn-success" disabled> <em class="icon ni ni-check"></em><span>Closed</span></button><br>
