                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input id="company_name" type="text" class="form-control " name="company_name" placeholder="Company Name" value=""
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input id="position" type="text" class="form-control" name="position" placeholder="Job Position" value=""
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input id="order_no" type="number" class="form-control" name="order_no" min="0.1"  step="0.1" placeholder="Order No" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <div class="preview-wrapper">
                                                            <img id="logo-preview" src="" alt="store logo" class="d-none" style="max-width:80px;max-height:120px" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
