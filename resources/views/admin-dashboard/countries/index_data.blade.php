                ...
                <div class="drodown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <ul class="link-list-opt no-bdr">
                            <li><a href="javascript:void(0)" class="edit-form" data-id="{{ $country->id }}"><em class="icon ni ni-edit"></em><span>Edit Country</span></a></li>
                            <li>
                                ...
                                <em class="icon ni ni-trash-fill"></em></em><span>Delete Country</span></a></li>
                        </ul>
                    </div>
                </div>
            </li>
