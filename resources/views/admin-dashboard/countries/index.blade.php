                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li><a href="#"  class="btn btn-primary btn-sm" class="btn btn-white btn-outline-light" id="show-modal"><em class="icon ni ni-plus"></em><span>Add Country</span></a></li>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#show-modal').on('click', function (event) {
                ...
                let url = "{{ route('admin.countries.create') }}";
                $.ajax({
                    url: url,
                    type: 'GET',
            ...
            function store() {
                $('#save_modal_form').on('submit', function (event) {
                    ...
                    let id = $('#id').val();
                    let method = 'POST';
                    let url = "{{ route('admin.countries.store') }}";
