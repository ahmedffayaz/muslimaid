        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="form-control-wrap ">
                    <input type="number" min="0.0" step="1" class="form-control" id="exit_click_id" value="{{ $isEdit ? $commission->exit_click_id : '' }}" name="exit_click_id" placeholder="Exit Click ID" required>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input type="number" class="form-control" min="0.0" step="1" id="order_value" value="{{ $isEdit ? $commission->order_value : '' }}" name="order_value" placeholder="Order Value">
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input type="number" class="form-control" id="network_commission" value="{{ $isEdit ? $commission->network_commission : '' }}" name="network_commission"
                        placeholder="Network Commission"  min="0.0" step="1" required>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
