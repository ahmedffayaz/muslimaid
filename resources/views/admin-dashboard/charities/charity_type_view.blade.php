            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content mt-5 pt-5">
                                ...
                                <div class="nk-tb-list nk-tb-ulist" id="table-data">
                                    ...
                                    @foreach ($CharityType as $charity)
                                        <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="tb-lead"><span><a href="{{route('admin.charities.charity_type_edit', $charity)}}" class="a_link">{{$charity->title}}</a></span></div>
                                                    </div>
                                                    <div class="nk-tb-col">
                                                        ...
                                                        <ul class="nk-tb-actions gx-1">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="{{route('admin.charities.charity_type_edit', $charity)}}"><em class="icon ni ni-edit"></em><span>Edit </span></a></li>
                                                                    <li><a  class='delete'  form_id = "delete-{{$charity->id}}"   style="cursor: pointer"> <em class="icon ni ni-trash-fill"></em><span>Delete</span></a>                       
