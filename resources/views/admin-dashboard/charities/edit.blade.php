                    ...
                    <div class="nk-block nk-block-lg">
                        ...
                        <div class="card">
                            <div class="card-inner">
                                ...
                                <form action="{{route('admin.charities.update',$charity)}}" class="gy-3 form-validate is-alter charity-form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap ">
                                                    <div class="form-control-select">
                                                        ...
                                                        <option  @if($charity->charity_types_id == $types->id) selected @endif value="{{$types->id}}" style="font-weight:bold">{{$types->title}}</option>
                                                        @endforeach
                                                        </select>
                                                    </div>
                                                </div>
