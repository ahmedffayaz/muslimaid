                    ...
                    <div class="nk-support-content">
                        <a href="{{ route(getAdminPrefix() . '.tickets.show', $ticket) }}">
                            <div class="title">
                                ...
                                <span class="badge badge-dot badge-dot-xs badge-warning ml-1">Awaiting your reply
                                </span>
                                @endif
                ...
                <div class="card-inner card-inner-md">
                    <div class="user-card">
                        ...
                        <div class="user-info">
                            ...
                            @if (isset($com->store))
                            <span class="sub-text">{{ $com->store->name }} <span
                                    class="badge badge-dim badge-pill badge-outline-primary ml-1">{{
                                    $com->store->network->name }}</span></span>
                            @endif
                        </div>
                        <div class="user-action nk-top-products">
                            <div class="total">
                                ...
                                <div class="count">
                                    @php echo
                                    \Carbon\Carbon::createFromTimeStamp(strtotime($com->event_date))->diffForHumans()
                                    @endphp
                                </div>
                ...
                <div class="nk-tb-item">
                    ...
                    <div class="nk-tb-col text-center">
                        <span> {!! $review->status == 'active' ? '<span
                                ...
                                class="tb-status badge badge-warning">pending</span>' !!}
                        </span>
                    </div>
