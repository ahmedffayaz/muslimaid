...
class StoreResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'banner_image_large' => $this->images->where('title', 'large cover')->first() ? getImageUrl($this->images->where('title', 'large cover')->first()) : '',
            'big_icon' => getImageUrl($this->logo->first()),
            'icon_large' => $this->images->where('title', 'large logo')->first() ? getImageUrl($this->images->where('title', 'large logo')->first()) : '',
